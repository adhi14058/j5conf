...
async function getConfig(
	...
	// currentConfig is object
		...
		//first handle #include directive to get the baseConfig
...
const loadConfig = async (configFilePath) => {
	...
	//remove #public in the keys of result variable - resultWithPublicConfig   and   gets the path to all those keys - pathsWithHashPublic
	const resultWithPublicConfig = extractPublicConfig(
		result,
		pathsWithHashPublic
	);

	//forms an object from the paths obtained above ad appends them to main result
